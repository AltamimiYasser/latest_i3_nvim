...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   ;; TODO: very nice if I can change it programatilcally
   ...
   ;; (default t)
   ;; TODO: change it and keep the todo mark so if there is any problem we can retrive it back
   ...
   ;; TODO: keep it like this and if it become cluttered change it to only files
...
(defun dotspacemacs/user-config ()
  ;; TODO: change user-config and keymapping?
